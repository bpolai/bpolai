...
## What I Do
- Design and deploy cloud infrastructure using Bicep, ARM, and Terraform  
- Build CI/CD pipelines using GitHub Actions, Azure DevOps & GitLab  
- Containerize and orchestrate applications with Docker & Kubernetes  
- Develop automation using Python & PowerShell  
